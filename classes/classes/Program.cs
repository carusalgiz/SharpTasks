...
namespace classes
{
    ...
    class Program
    {
        ...
        {
            var arraySex = new [] {"женщина", "мужчина"};
            var arrayHeight = new [] { 162, 156, 160, 170, 163, 167, 172, 182, 185, 186, 190, 164 };
            var arrayWeigth = new [] { 45, 46, 47, 58, 49, 50, 51, 52, 53, 54, 55, 56, 60, 62, 65, 67 };
            var arrayTraits = new [] { "добрый", "раздражительный", "молчаливый", "общительный", "дружелюбный", "пессимист", "оптимист", "агрессивный", "замкнутый", "странный" };
            var arrayMarital = new [] { "в браке", "в активном поиске", "разведен/на", "помолвлен/на"};
            var arrayChildren = new [] { "имеются", "не имеются" };
            int number;
